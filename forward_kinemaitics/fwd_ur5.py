...
from sympy import Matrix, symbols, cos, sin, pi ,simplify 
import numpy as np 
...
A=Rz*Tz*Tx*Rx
A01 =A.subs({t:0 ,d:0.45 ,a:0 ,aph:0 })
A12 =A.subs({t:t1+pi ,d:0 ,a:-0.155 ,aph:pi/2 })
A23 =A.subs({t:t2+pi ,d:0 ,a:0 ,aph:pi/2 })
A34 =A.subs({t:0 , d:0.614 ,a:-0.000120 ,aph:pi/2 })
A44p =A.subs({t:t3+pi , d:0 ,a:0,aph:pi/2 })
A4p5 =A.subs({t:0 , d:0.1996 ,a:-0.640 ,aph:pi/2 })
A55p =A.subs({t:t5+pi/2 , d:0 ,a:0,aph:pi/2 })
A5p = A.subs({t:0 , d:-0.1, a:0, aph:0})
...
class JointSubscriber(Node):
    ...
    def sub_callback(self,msg):
        ...
        T= A01*A12*A23*A34*A44p*A4p5*A55p*A5p*A67*At
        #T=A.subs({t:0,d:0,a:0,aph:pi/2})*A01*
